...
class TicketingServiceProvider extends PackageServiceProvider
{
    public function configurePackage(Package $package): void
    {
        $package
            ...
            ->hasConfigFile()
            ->hasViews('ticketing')
            ->hasMigrations(['create_ticketing_tables', 'create_ticketing_settings_table', 'create_ticketing_connections_table', 'update_ticketing_connections_add_test_mode', 'update_ticketing_connections_add_stripe_keys', 'update_ticketing_orders_add_connection', 'update_ticketing_questions_add_ticket_type', 'create_ticketing_logs_table', 'update_ticketing_events_add_media', 'update_ticketing_events_add_attendee_details'])
            ->hasCommands([
